...
class PromiseTest extends \PHPUnit_Framework_TestCase
{
   ...
   /* public function testPromiseTest__victorynoxTest()
    {
        $this->object = new Client($this->store);
        ...
        if (rand(0, 1)) {
            $this->assertEquals($this->object->getId(), $this->object->resolve(new \stdClass()));
        } else {
            $this->assertEquals($this->object->getId(), $this->object->reject("Rand is 0. Then"));
        }
