 ...
 * @package    zaboy
 */
abstract class PromiseClien_t //implements PromiseInterface
{

    public $promiseId;
    public $state = Promise::PENDING;
    public $result;
    public $cancelFn;
    public $waitFn;
    public $waitList;
    ...
    {
        if (!isset(PromiseBroker::$promiseAdapter)) {
            throw new PromiseException("You have to create PromiseBroker before to use PromiseClient");
        }
        $this->promiseAdapter = PromiseBroker::$promiseAdapter;
        $this->waitFn = $waitFn;
