...
class BrokerFactoryTest extends \PHPUnit_Framework_TestCase
{
    ...
    const TEST_TABLE_NAME = 'test_mysqlBrokerFactory';
    ...
    {
        $adapter = $this->object->__invoke($this->container, '', [MySqlAdapterFactory::KEY_TABLE_NAME => self::TEST_TABLE_NAME]);
        $this->assertSame(
                get_class($adapter), 'zaboy\async\Promise\Broker'
        );
    }
